exports.handler = async function(event) {
  ...
  try {
    ...
    var V1_MAKE = 'DP3tVjiga7PPqKrztB0D'; var V1_MODEL = 'uJec2Q884qeBQ1lxHJ3U'; var V1_PLATE = 'i5dJ5scIr0pBROE8nslQ';
    var V2_MAKE = 'BGc2BxNWQCBEeuYgI8wE'; var V2_MODEL = 'DAAiZk2v9dt2lWHFistw'; var V2_PLATE = '1FUbhp6qXLo2iDcOOpfb';
    var V3_MAKE = 'I5ESEXncfU7JPRO5cCDY'; var V3_MODEL = '727yuempYIr4WCmOnhVA'; var V3_PLATE = 'RgF1p5wAa0nTCRJs7mbr';
    ...
    return { statusCode: 200, body: JSON.stringify({ found: true, name: match.firstName + ' ' + match.lastName, status: getVal(fields, STATUS_ID) || 'unknown', plate: plate, vehicle1: v1, vehicle2: v2, vehicle3: v3 }) };
